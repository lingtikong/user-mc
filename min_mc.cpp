/* -------------------------------------------------------------------------------------------------
 * Monte Carlo simulation with constant N, P, T, and chemical potential difference.
 * Reference:
 *    Robert Joseph Fagan, "Embedded Atom Method Monte Carlo simulation of Cu-Ni bulk alloy" (2012).
 *    Theses and Dissertations. Paper. 1181, Lehigh University.
 *
 * ------------------------------------------------------------------------------------------------- */
#include "min_mc.h"
#include "atom.h"
